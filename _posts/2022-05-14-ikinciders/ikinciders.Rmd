...
Eğer içerisindeki elemanların hepsi aynı veri tipinden değilse şu şekilde dönüşümler olur:
Numeric/double ve logical veri tipleri, eğer vektör içinde bir character varsa character veri tipine dönüşürler.
Logical veri tipi eğer vektör içinde bir numeric/double varsa numeric/double veri tipine dönüşür.
